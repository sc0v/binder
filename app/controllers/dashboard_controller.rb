...
class DashboardController < ApplicationController
  ...
  def start
    ...
    unless Dashboard::FlowDefinition.valid_kind?(kind)
      redirect_to dashboard_path, alert: t('dashboard.errors.invalid_flow_kind')
      return
    end
  ...
  def cancel
    ...
    redirect_to dashboard_path, notice: t('dashboard.notices.action_canceled')
  end
  ...
  def action_requires_confirmation?(action_name)
    handler = Dashboard::ActionRegistry.handler_for_action(action_name)
