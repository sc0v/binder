...
class PowerDashboardController < ApplicationController
  ...
  def autocomplete
    ...
    suggestions = Dashboard::AutocompleteSuggestions.new(query:, include_actions: include_actions).call
  ...
  def action_executor
    @action_executor ||= Dashboard::ActionExecutor.new(session_state:, ability: method(:can?))
  end
