...
(function (e, r) {
  ...
  e.utils = { decode: N, encode: I, hascp: F, magic: r, cache: S };
  return e;
});
var XLSX = {};
function make_xlsx_lib(e) {
  ...
  function P(e, r) {
    var t = "" + e;
    return t.length >= r ? t : Tr("0", r - t.length) + t;
  }
  function L(e, r) {
    var t = "" + e;
    return t.length >= r ? t : Tr(" ", r - t.length) + t;
  }
  function M(e, r) {
    var t = "" + e;
    return t.length >= r ? t : t + Tr(" ", r - t.length);
  }
  function U(e, r) {
    var t = "" + Math.round(e);
    return t.length >= r ? t : Tr("0", r - t.length) + t;
  ...
  function ue(e, r, t) {
    var a = r.replace(he, ""),
      n = r.length - a.length;
    return Ie(e, a, t * Math.pow(10, 2 * n)) + Tr("%", n);
  }
  function de(e, r, t) {
    var a = r.length - 1;
  ...
  function ge(e, r, t) {
    ...
    return (
      ...
      " " +
      (s === 0
        ? Tr(" ", e[1].length + 1 + e[4].length)
        : L(s, e[1].length) + e[2] + "/" + e[3] + P(f, e[4].length))
    );
  }
  function me(e, r, t) {
    return t + (r === 0 ? "" : "" + r) + Tr(" ", e[1].length + 2 + e[4].length);
  }
  var be = /^#*0*\.([0#]+)/;
  var we = /\).*[0#]/;
  var ke = /\(###\) ###\\?-####/;
  ...
  function Se(e, r, t) {
    ...
    if ((i = r.match(be))) {
      n = Ae(t, i[1].length)
        ...
        .replace(/\.(\d*)$/, function (e, r) {
          return "." + r + Tr("0", Te(i[1]).length - r.length);
        });
    ...
    if ((i = r.match(/^([0#]+)(\\?-([0#]+))+$/))) {
      n = D(Se(e, r.replace(/[\\-]/g, ""), t));
      s = 0;
      return D(
        D(r.replace(/\\/g, "")).replace(/[0#]/g, function (e) {
    ...
    if ((i = r.match(/^# ([#0?]+)( ?)\/( ?)([#0?]+)/))) {
      ...
      return (
        ...
        (f[1]
          ...
          : Tr(" ", 2 * s + 1 + i[2].length + i[3].length))
      );
    }
    if ((i = r.match(/^[#0?]+$/))) {
      n = H(t, 0);
  ...
  function Re(e, r, t) {
    ...
    if ((i = r.match(/^#,##0\.([#0]*0)$/))) {
      return t < 0
        ? "-" + Re(e, r, -t)
        : ce("" + t) + "." + Tr("0", i[1].length);
    }
    if ((i = r.match(/^#,#*,#0/))) return Re(e, r.replace(/^#,#*,/, ""), t);
    if ((i = r.match(/^([0#]+)(\\?-([0#]+))+$/))) {
      n = D(Re(e, r.replace(/[\\-]/g, ""), t));
      s = 0;
      return D(
        D(r.replace(/\\/g, "")).replace(/[0#]/g, function (e) {
          return s < n.length ? n.charAt(s++) : e === "0" ? "0" : "";
      ...
      switch ((f = e.charAt(s))) {
        ...
        case "上":
          ...
          if (e.substr(s, 3).toUpperCase() === "A/P") {
            if (l != null) p.v = l.H >= 12 ? e.charAt(s + 2) : f;
            p.t = "T";
            u = "h";
            s += 3;
  ...
  var qe = (function Xw() {
    ...
    function p(e, r, t, a, n) {
      ...
      if (e === U) {
        ...
        if (!s) return;
        for (var o = 0; o < f; ++o) {
          if ((i = na(s, o * 4)) === U) break;
          n.push(i);
        }
        if (r >= 1) p(na(s, a - 4), r - 1, t, a, n);
      }
    }
    ...
    function P(e, r) {
      ...
      for (i = 0; i < a[4] << 2; ++i) {
        ...
        if (u.length > 32) {
          console.error(
            "Name " + u + " will be truncated to " + u.slice(0, 32),
          );
          u = u.slice(0, 32);
        }
        l = 2 * (u.length + 1);
    ...
    function L(e, r) {
      ...
      for (s = 0; s < t.length; ++s) {
        if ((f ? t[s].replace(F, "!") : t[s]).replace(N, "") == i)
          return e.FileIndex[s];
        if ((f ? a[s].replace(F, "!") : a[s]).replace(N, "") == i)
          return e.FileIndex[s];
      }
      return null;
    }
    ...
    function Te(e) {
      var r = va(50 + Math.floor(e.length * 1.1));
      var t = ke(e, r);
      return r.slice(0, t);
    }
  ...
  function rr(e, r, t) {
    if (typeof Ze !== "undefined" && Ze.writeFileSync)
      return t ? Ze.writeFileSync(e, r, t) : Ze.writeFileSync(e, r);
    ...
    if (typeof Blob !== "undefined") {
      var n = new Blob([er(a)], { type: "application/octet-stream" });
  ...
  function tr(e) {
    if (typeof Ze !== "undefined") return Ze.readFileSync(e);
  ...
  var or = new Date(1899, 11, 30, 0, 0, 0);
  function lr(e, r) {
    var t = e.getTime();
    if (r) t -= 1462 * 24 * 60 * 60 * 1e3;
    var a =
      or.getTime() + (e.getTimezoneOffset() - or.getTimezoneOffset()) * 6e4;
    return (t - a) / (24 * 60 * 60 * 1e3);
  }
  var cr = new Date();
  var hr =
    or.getTime() + (cr.getTimezoneOffset() - or.getTimezoneOffset()) * 6e4;
  var ur = cr.getTimezoneOffset();
  function dr(e) {
    var r = new Date();
    r.setTime(e * 24 * 60 * 60 * 1e3 + hr);
    if (r.getTimezoneOffset() !== ur) {
      r.setTime(r.getTime() + (r.getTimezoneOffset() - ur) * 6e4);
    }
    return r;
  }
  function vr(e) {
  ...
  var pr = new Date("2017-02-19T19:06:09.000Z");
  var gr = isNaN(pr.getFullYear()) ? new Date("2/19/17") : pr;
  var mr = gr.getFullYear() == 2017;
  function br(e, r) {
    var t = new Date(e);
    if (mr) {
  ...
  function wr(e, r) {
    if (T && Buffer.isBuffer(e)) {
      if (r) {
        ...
        if (e[1] == 254 && e[2] == 255)
          return ut(u(e.slice(2).toString("binary")));
      }
  ...
  function kr(e) {
    ...
    var r = {};
    for (var t in e)
      if (Object.prototype.hasOwnProperty.call(e, t)) r[t] = kr(e[t]);
    return r;
  }
  function Tr(e, r) {
    var t = "";
  ...
  function Cr(e) {
    ...
    if (s.match(/jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec/)) {
      ...
      if (s.length > 3 && Er.indexOf(s) == -1) return t;
  ...
  function Sr(e) {
    if (!e) return null;
    if (e.content && e.type) return wr(e.content, true);
    ...
    if (e._data && e._data.getContent)
      return d(wr(Array.prototype.slice.call(e._data.getContent(), 0)));
    return null;
  }
  function _r(e) {
    if (!e) return null;
  ...
  var Br = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>\r\n';
  var Wr =
    /([^"\s?>\/]+)\s*=\s*((?:")([^"]*)(?:")|(?:')([^']*)(?:')|([^'">\s]+))/g;
  var Hr =
      /<[\/\?]?[a-zA-Z0-9:_-]+(?:\s+[^"\s?>\/]+\s*=\s*(?:"[^"]*"|'[^']*'|[^'">\s=]+))*\s*[\/\?]?>/gm,
    zr = /<[^>]*>/g;
  var Vr = Br.match(Hr) ? Hr : zr;
  var Gr = /<\w*:/,
    jr = /<(\/?)\w+:/;
  function Xr(e, r, t) {
    var a = {};
  ...
  var ct = "foo bar bazâð£";
  var ht = (T && ((lt(ct) == ft(ct) && lt) || (ot(ct) == ft(ct) && ot))) || ft;
  var ut = T
    ? function (e) {
  ...
  function bt(e, r) {
    ...
    a.forEach(function (e) {
      var r = e.replace(gt, "").match(mt);
      if (r) n.push({ v: ht(r[2]), t: r[1] });
    });
    return n;
  }
  var wt = /(^\s|\s$|\n)/;
  ...
  function At(e, r, t) {
    return (
      ...
      (t != null ? Tt(t) : "") +
      (r != null
        ? (r.match(wt) ? ' xml:space="preserve"' : "") + ">" + r + "</" + e
        : "/") +
      ">"
    );
  }
  ...
  function Ct(e, r) {
    switch (typeof e) {
      case "string":
        var t = At("vt:lpwstr", Qr(e));
        if (r) t = t.replace(/&quot;/g, "_x0022_");
        return t;
      case "number":
        return At((e | 0) == e ? "vt:i4" : "vt:r8", Qr(String(e)));
      case "boolean":
        return At("vt:bool", e ? "true" : "false");
    }
    if (e instanceof Date) return At("vt:filetime", Et(e));
  ...
  var Dt = function (e, r, t) {
    var a = [];
    for (var n = r; n < t; n += 2) a.push(String.fromCharCode(ra(e, n)));
    return a.join("").replace(N, "");
  };
  var Pt = T
    ? function (e, r, t) {
        if (!Buffer.isBuffer(e)) return Dt(e, r, t);
  ...
  var Mt = T
    ? function (e, r, t) {
        return Buffer.isBuffer(e) ? e.toString("hex", r, r + t) : Lt(e, r, t);
      }
    : Lt;
  var Ut = function (e, r, t) {
    var a = [];
    for (var n = r; n < t; n++) a.push(String.fromCharCode(ea(e, n)));
    return a.join("");
  };
  var Bt = T
    ? function $w(e, r, t) {
        return Buffer.isBuffer(e) ? e.toString("utf8", r, t) : Ut(e, r, t);
      }
    : Ut;
  var Wt = function (e, r) {
    var t = aa(e, r);
    return t > 0 ? Bt(e, r + 4, r + 4 + t - 1) : "";
  };
  var Ht = Wt;
  var zt = function (e, r) {
    var t = aa(e, r);
  ...
  var jt = Gt;
  var Xt = function Yw(e, r) {
    var t = aa(e, r);
    return t > 0 ? Pt(e, r + 4, r + 4 + t) : "";
  };
  var $t = Xt;
  var Yt = function (e, r) {
    var t = aa(e, r);
    return t > 0 ? Bt(e, r + 4, r + 4 + t) : "";
  };
  var Kt = Yt;
  var Jt = function (e, r) {
    return Rt(e, r);
    ...
    switch (t) {
      case "dbcs":
        ...
        if (T && Buffer.isBuffer(this))
          ...
          for (c = 0; c < e; ++c) {
            n += String.fromCharCode(ra(this, h));
            h += 2;
          }
        e *= 2;
        break;
      case "utf8":
        n = Bt(this, this.l, this.l + e);
        break;
      case "utf16le":
        e *= 2;
        n = Pt(this, this.l, this.l + e);
        break;
      case "wstr":
        if (typeof a !== "undefined")
      ...
      case "cstr":
        e = 0;
        n = "";
        while ((o = ea(this, this.l + e++)) !== 0) f.push(v(o));
        n = f.join("");
        break;
      case "_wstr":
        e = 0;
        n = "";
        while ((o = ra(this, this.l + e)) !== 0) {
          f.push(v(o));
          e += 2;
        }
        e += 2;
      ...
      case "dbcs-cont":
        ...
        for (c = 0; c < e; ++c) {
          if (this.lens && this.lens.indexOf(h) !== -1) {
            o = ea(this, h);
            this.l = h + 1;
            l = sa.call(this, e - c, o ? "dbcs-cont" : "sbcs-cont");
            return f.join("") + l;
          }
          f.push(v(ra(this, h)));
          h += 2;
      ...
      default:
        switch (e) {
          case 1:
            ...
            return i;
          case 2:
            i = (t === "i" ? ta : ra)(this, this.l);
            this.l += 2;
            return i;
          case 4:
          case -4:
            if (t === "i" || (this[this.l + 3] & 128) === 0) {
              i = (e > 0 ? na : ia)(this, this.l);
              this.l += 4;
              return i;
            } else {
              s = aa(this, this.l);
  ...
  function ca(e, r, n) {
    var i = 0,
      s = 0;
    if (n === "dbcs") {
      for (s = 0; s != r.length; ++s) la(this, r.charCodeAt(s), this.l + 2 * s);
      i = 2 * r.length;
    } else if (n === "sbcs") {
  ...
  function ha(e, r) {
    var t = Mt(this, this.l, e.length >> 1);
  ...
  function ka(e, r) {
    ...
    var t = Na(e);
    if (!e.cRel && e.cRel != null) t = xa(t);
    if (!e.rRel && e.rRel != null) t = Ca(t);
    return t;
  }
  function Ta(e, r) {
    if (e.s.r == 0 && !e.s.rRel) {
    ...
    return ka(e.s, r.biff) + ":" + ka(e.e, r.biff);
  }
  function Aa(e) {
  ...
  function Fa(e) {
    var r = e.indexOf(":");
    if (r == -1) return { s: Ia(e), e: Ia(e) };
    return { s: Ia(e.slice(0, r)), e: Ia(e.slice(r + 1)) };
  }
  function Da(e, r) {
    if (typeof r === "undefined" || typeof r === "number") {
      return Da(e.s, e.e);
    }
    if (typeof e !== "string") e = Na(e);
    if (typeof r !== "string") r = Na(r);
    return e == r ? e : e + ":" + r;
  }
  function Pa(e) {
  ...
  function La(e, r) {
    ...
    if (e.z != null)
      try {
        return (e.w = Be(e.z, t ? lr(r) : r));
      } catch (a) {}
    try {
      return (e.w = Be((e.XF || {}).numFmtId || (t ? 14 : 0), t ? lr(r) : r));
    } catch (a) {
      return "" + r;
    }
  }
  function Ma(e, r, t) {
    ...
    if (r == undefined) return La(e, e.v);
    return La(e, r);
  }
  function Ua(e, r) {
  ...
  function Ba(e, r, t) {
    ...
    if (i && a.origin != null) {
      if (typeof a.origin == "number") s = a.origin;
        ...
        var o = typeof a.origin == "string" ? Ia(a.origin) : a.origin;
        s = o.r;
        f = o.c;
      }
  ...
  function ln(e) {
    ...
    var n =
      a === 0
        ? qt([0, 0, 0, 0, r[0] & 252, r[1], r[2], r[3]], 0)
        : na(r, 0) >> 2;
    return t ? n / 100 : n;
  }
  function cn(e, r) {
  ...
  var Mn = {
    1: { n: "CodePage", t: Cn },
    2: { n: "Category", t: Dn },
    3: { n: "PresentationFormat", t: Dn },
    4: { n: "ByteCount", t: yn },
    5: { n: "LineCount", t: yn },
    6: { n: "ParagraphCount", t: yn },
    7: { n: "SlideCount", t: yn },
    8: { n: "NoteCount", t: yn },
    9: { n: "HiddenCount", t: yn },
    10: { n: "MultimediaClipCount", t: yn },
    11: { n: "ScaleCrop", t: Sn },
    12: { n: "HeadingPairs", t: Nn },
    13: { n: "TitlesOfParts", t: Fn },
    14: { n: "Manager", t: Dn },
    15: { n: "Company", t: Dn },
    16: { n: "LinksUpToDate", t: Sn },
    17: { n: "CharacterCount", t: yn },
    19: { n: "SharedDoc", t: Sn },
    22: { n: "HyperlinksChanged", t: Sn },
    23: { n: "AppVersion", t: yn, p: "version" },
    24: { n: "DigSig", t: Rn },
    26: { n: "ContentType", t: Dn },
    27: { n: "ContentStatus", t: Dn },
    28: { n: "Language", t: Dn },
    29: { n: "Version", t: Dn },
    255: {},
    2147483648: { n: "Locale", t: xn },
    2147483651: { n: "Behavior", t: xn },
    1919054434: {},
  };
  var Un = {
    1: { n: "CodePage", t: Cn },
    ...
    9: { n: "RevNumber", t: Dn },
    10: { n: "EditTime", t: On },
    11: { n: "LastPrinted", t: On },
    12: { n: "CreatedDate", t: On },
    13: { n: "ModifiedDate", t: On },
    14: { n: "PageCount", t: yn },
    15: { n: "WordCount", t: yn },
    16: { n: "CharCount", t: yn },
    17: { n: "Thumbnail", t: In },
    18: { n: "Application", t: Dn },
    19: { n: "DocSecurity", t: yn },
    255: {},
    2147483648: { n: "Locale", t: xn },
    2147483651: { n: "Behavior", t: xn },
    1919054434: {},
  ...
  function Kn(e) {
    ...
    var t = {};
    (e.match(Vr) || []).forEach(function (e) {
      var a = Xr(e);
      switch (a[0].replace(Gr, "<")) {
        case "<?xml":
          break;
        case "<Types":
  ...
  function Jn(e, r) {
    ...
    a = a.concat(
      [
        ...
        return At("Default", null, { Extension: e[0], ContentType: e[1] });
      }),
    );
    var i = function (t) {
      if (e[t] && e[t].length > 0) {
        n = e[t][0];
        a[a.length] = At("Override", null, {
          PartName: (n[0] == "/" ? "" : "/") + n,
  ...
  function Qn(e, r) {
    ...
    (e.match(Vr) || []).forEach(function (e) {
      ...
      if (n[0] === "<Relationship") {
        ...
        var s = n.TargetMode === "External" ? n.Target : Ur(n.Target, r);
        t[s] = i;
        a[n.Id] = i;
      }
    });
  ...
  function ei(e) {
    var r = [Br, At("Relationships", null, { xmlns: _t.RELS })];
    ar(e["!id"]).forEach(function (t) {
      r[r.length] = At("Relationship", null, e["!id"][t]);
    });
    if (r.length > 2) {
  ...
  function hi(e) {
    ...
    for (var t = 0; t < li.length; ++t) {
      var a = li[t],
        n = e.match(ci[t]);
      if (n != null && n.length > 0) r[a[1]] = Jr(n[1]);
      if (a[2] === "date" && r[a[1]]) r[a[1]] = br(r[a[1]]);
    }
    return r;
  }
  function ui(e, r, t, a, n) {
    ...
    n[e] = r;
    r = Qr(r);
    a[a.length] = t ? At(e, r, t) : kt(e, r);
  }
  function di(e, r) {
    var t = r || {};
    var a = [
        Br,
        At("cp:coreProperties", null, {
  ...
  function Ti(e) {
    var r = [
      Br,
      At("Properties", null, { xmlns: _t.CUST_PROPS, "xmlns:vt": _t.vt }),
    ];
    if (!e) return r.join("");
    var t = 1;
    ar(e).forEach(function a(n) {
      ++t;
      r[r.length] = At("property", Ct(e[n], true), {
  ...
  function yi(e, r) {
    ...
    ar(Ai)
      ...
      .forEach(function (a) {
        ...
        t.push(kt(Ai[a[1]] || a[1], n));
      });
    return At("DocumentProperties", t.join(""), { xmlns: Ot.o });
  }
  function Si(e, r) {
    ...
    if (e)
      ar(e).forEach(function (r) {
        ...
        n.push(At(et(r), i, { "dt:dt": s }));
      });
    if (r)
      ar(r).forEach(function (t) {
        ...
        n.push(At(et(t), a, { "dt:dt": i }));
      });
    return "<" + a + ' xmlns="' + Ot.o + '">' + n.join("") + "</" + a + ">";
  }
  function _i(e) {
    var r = e._R(4),
      t = e._R(4);
  ...
  function zi(e, r) {
    ...
    switch (e) {
      ...
      case 31:
      case 80:
        a = va(4 + 2 * (r.length + 1) + (r.length % 2 ? 0 : 2));
        a._W(4, r.length + 1);
        a._W(0, r, "dbcs");
  ...
  function Xi(e, r, t) {
    ...
    if (!r) {
      ...
      for (f = 0; f < e.length; ++f) {
        var h = e[f][0];
        o = va(4 + 4 + 2 * (h.length + 1) + (h.length % 2 ? 0 : 2));
        o._W(4, f + 2);
        o._W(4, h.length + 1);
        o._W(0, h, "dbcs");
  ...
  function $i(e, r, t) {
    ...
    var l = a._R(4);
    var c = a._R(16);
    if (c !== qe.utils.consts.HEADER_CLSID && c !== t)
  ...
  function df(e, r, t, a) {
    var n = t && t.biff == 5;
    if (!a) a = va(n ? 3 + r.length : 5 + 2 * r.length);
    a._W(2, e);
    a._W(n ? 1 : 2, r.length);
    if (!n) a._W(1, 1);
  ...
  var Ao = (function () {
    ...
    function l(e, a) {
      ...
      var i = ga();
      var s = vw(e, { header: 1, raw: true, cellDates: true });
      var l = s[0],
        c = s.slice(1),
        h = e["!cols"] || [];
      var u = 0,
                ...
                switch (A[h].charAt(0)) {
                  ...
                  case "K":
                    ...
                    if (C.charAt(0) === '"') C = C.slice(1, C.length - 1);
                      ...
                      C = Ar(C);
                      if (v !== null && De(v)) C = dr(C);
                    } else if (!isNaN(Cr(C).getDate())) {
                      C = br(C);
                    }
                    if (
                      typeof a !== "undefined" &&
      ...
      for (; i !== t.length; ++i) {
        ...
        switch (+o) {
          ...
          case 0:
            ...
            else if (!isNaN(Ar(l))) s[a][n] = Ar(l);
            else if (!isNaN(Cr(l).getDate())) s[a][n] = br(l);
            else s[a][n] = l;
            ++n;
            break;
          case 1:
          ...
          for (var o = n.s.c; o <= n.e.c; ++o) {
            ...
            switch (i.t) {
              ...
              case "s":
                ...
                break;
              case "d":
                if (!i.w) i.w = Be(i.z || X[14], lr(br(i.v)));
                if (m) r(a, 0, i.w, "V");
                else r(a, 1, 0, i.w);
                break;
              default:
  ...
  var So = (function () {
    function e(e, r, t, a, n) {
      ...
      else if (!isNaN(Ar(e))) r[t][a] = Ar(e);
      else if (!isNaN(Cr(e).getDate())) r[t][a] = br(e);
      else r[t][a] = e;
    }
    function r(r, t) {
      var a = t || {};
    ...
    function s(e, r) {
      ...
      function b() {
        ...
        if (r.length === 0) a.t = "z";
          ...
          a.t = "b";
          a.v = false;
        } else if (!isNaN((l = Ar(r)))) {
          a.t = "n";
          if (t.cellText !== false) a.w = r;
          a.v = l;
        } else if (!isNaN(Cr(r).getDate()) || (m && r.match(m))) {
          a.z = t.dateNF || X[14];
          var i = 0;
          if (m && r.match(m)) {
          ...
          if (t.cellText !== false)
            a.w = Be(a.z, a.v instanceof Date ? lr(a.v) : a.v);
    ...
    function o(e, r) {
      var t = "",
        n = r.type == "string" ? [0, 0, 0, 0] : zb(e, r);
      switch (r.type) {
        case "base64":
          t = k(e);
          break;
      ...
      if (n[0] == 239 && n[1] == 187 && n[2] == 191) t = ht(t.slice(3));
      ...
      if (t.slice(0, 19) == "socialcalc:version:")
        return yo.to_sheet(r.type == "string" ? t : ht(t), r);
      return f(t, r);
    }
    function l(e, r) {
      return Ua(o(e, r), r);
          ...
          function (e, r, t) {
            switch (t) {
              ...
              case 16:
                ...
                var c = a.dense ? (n[e[0].r] || [])[e[0].c] : n[Na(e[0])];
                if (c) {
                  c.t = e[1].t;
                  c.v = e[1].v;
        ...
        for (var p = n.s.c; p <= n.e.c; ++p) {
          ...
          if (b.t == "n") {
            if ((b.v | 0) == b.v && b.v >= -32768 && b.v <= 32767)
              om(a, 13, v(h, p, b.v));
            else om(a, 14, m(h, p, b.v));
          } else {
            var w = Ma(b);
            om(a, 15, u(h, p, w.slice(0, 239)));
          }
        }
      }
      om(a, 1);
  ...
  function Po(e, r) {
    ...
    if (e.match(/^\s*<(?:\w+:)?t[^>]*>/)) {
      a.t = Jr(
        ht(e.slice(e.indexOf(">") + 1).split(/<\/(?:\w+:)?t>/)[0] || ""),
      );
      a.r = ht(e);
      if (t) a.h = tt(a.t);
    } else if (e.match(Fo)) {
      a.r = ht(e);
      a.t = Jr(
        ht((e.replace(Do, "").match(No) || []).join("").replace(Vr, "")),
      );
      if (t) a.h = Io(Ro(a.r));
    }
    return a;
  ...
  function Xo(e) {
    var r = ga();
    ma(r, 159, Go(e));
    for (var t = 0; t < e.length; ++t) ma(r, 19, jo(e[t]));
    ma(r, 160);
    return r.end();
  }
  function $o(e) {
  ...
  function Ml(e, r, t, a) {
    ...
    var n = {};
    var i = false;
    (e[0].match(Vr) || []).forEach(function (e) {
      var t = Xr(e);
      switch ($r(t[0])) {
        case "<borders":
        case "<borders>":
        ...
        case "<border/>":
          n = {};
          if (t.diagonalUp) n.diagonalUp = st(t.diagonalUp);
          if (t.diagonalDown) n.diagonalDown = st(t.diagonalDown);
          r.Borders.push(n);
          break;
        case "</border>":
          break;
    ...
    (e[0].match(Vr) || []).forEach(function (e) {
      ...
      switch ($r(f[0])) {
        ...
        case "<font/>":
          ...
          break;
        case "<name":
          if (f.val) n.name = ht(f.val);
          break;
        case "<name/>":
        case "</name>":
          break;
        case "<b":
          n.bold = f.val ? st(f.val) : 1;
          break;
        case "<b/>":
          n.bold = 1;
          break;
        case "<i":
          n.italic = f.val ? st(f.val) : 1;
          break;
        case "<i/>":
          n.italic = 1;
          break;
        ...
        case "<u/>":
          ...
          break;
        case "<strike":
          n.strike = f.val ? st(f.val) : 1;
          break;
        case "<strike/>":
          n.strike = 1;
          break;
        case "<outline":
          n.outline = f.val ? st(f.val) : 1;
          break;
        case "<outline/>":
          n.outline = 1;
          break;
        case "<shadow":
          n.shadow = f.val ? st(f.val) : 1;
          break;
        case "<shadow/>":
          n.shadow = 1;
          break;
        case "<condense":
          n.condense = f.val ? st(f.val) : 1;
          break;
        case "<condense/>":
          n.condense = 1;
          break;
        case "<extend":
          n.extend = f.val ? st(f.val) : 1;
          break;
        case "<extend/>":
          n.extend = 1;
          break;
        ...
        case "<color":
          if (!n.color) n.color = {};
          if (f.auto) n.color.auto = st(f.auto);
  ...
  function Hl(e) {
    ...
    r[r.length] = "</numFmts>";
    r[0] = At("numFmts", null, { count: r.length - 2 }).replace("/>", ">");
    return r.join("");
  }
    ...
    (e[0].match(Vr) || []).forEach(function (e) {
      ...
      switch ($r(i[0])) {
        ...
        case "<xf/>":
          ...
          for (s = 0; s < Vl.length; ++s) if (a[Vl[s]]) a[Vl[s]] = st(a[Vl[s]]);
        ...
        case "<alignment/>":
          ...
          if (i.wrapText) f.wrapText = st(i.wrapText);
          a.alignment = f;
          break;
        case "</alignment>":
          break;
  ...
  function jl(e) {
    var r = [];
    r[r.length] = At("cellXfs", null);
    e.forEach(function (e) {
      r[r.length] = At("xf", null, e);
    });
    r[r.length] = "</cellXfs>";
    if (r.length === 2) return "";
    r[0] = At("cellXfs", null, { count: r.length - 2 }).replace("/>", ">");
    return r.join("");
  }
  var Xl = (function nk() {
  ...
  function $l(e, r) {
    var t = [Br, At("styleSheet", null, { xmlns: xt[0], "xmlns:vt": _t.vt })],
      a;
  ...
  function uc(e) {
    ...
    if (r == 0) return;
    ma(e, 603, za(r));
    ma(e, 45, rc({ patternType: "none" }));
    ma(e, 45, rc({ patternType: "gray125" }));
    ma(e, 604);
  }
  function dc(e) {
    var r = 1;
  ...
  function vc(e) {
    var r = 1;
    ma(e, 626, za(r));
    ma(e, 47, ac({ numFmtId: 0, fontId: 0, fillId: 0, borderId: 0 }, 65535));
    ma(e, 627);
  }
  function pc(e, r) {
    ma(e, 617, za(r.length));
  ...
  function gc(e) {
    var r = 1;
    ma(e, 619, za(r));
    ma(e, 48, fc({ xfId: 0, builtinId: 0, name: "Normal" }));
    ma(e, 620);
  }
  function mc(e) {
    var r = 0;
  ...
  function bc(e) {
    var r = 0;
    ma(e, 508, oc(r, "TableStyleMedium9", "PivotStyleMedium4"));
    ma(e, 509);
  }
  function wc() {
    return;
  ...
  function Nc(e, r, t) {
    ...
    var o = Nr(s, "theme/theme/theme1.xml", true);
    if (!o) return;
    return Rc(o, t);
  }
  function Fc(e) {
  ...
  function Wc(e, r) {
    return { flags: e._R(4), version: e._R(4), name: Va(e, r - 8) };
  }
  function Hc(e) {
    var r = va(12 + 2 * e.name.length);
    r._W(4, e.flags);
    r._W(4, e.version);
    Ga(e.name, r);
    return r.slice(0, r.l);
  ...
  function Yc() {
    ...
    ma(e, 332);
    ma(e, 334, za(1));
    ma(e, 335, Hc({ name: "XLDAPR", version: 12e4, flags: 3496657072 }));
    ma(e, 336);
    ma(e, 339, Gc(1, "XLDAPR"));
    ma(e, 52);
    ma(e, 35, za(514));
    ma(e, 4096, za(0));
    ma(e, 4097, rs(1));
  ...
  function nh(e, r) {
    ...
    var n = [
      ...
      At("o:shapelayout", At("o:idmap", null, { "v:ext": "edit", data: e }), {
        "v:ext": "edit",
      }),
      At(
        "v:shapetype",
        [
          At("v:stroke", null, { joinstyle: "miter" }),
          At("v:path", null, { gradientshapeok: "t", "o:connecttype": "rect" }),
        ].join(""),
    ...
    r.forEach(function (e) {
      ...
      var a =
        t.type == "gradient"
          ? At("o:fill", null, { type: "gradientUnscaled", "v:ext": "view" })
          : null;
      var i = At("v:fill", a, t);
      ...
      n = n.concat([
        ...
        i,
        At("v:shadow", null, s),
        At("v:path", null, { "o:connecttype": "none" }),
  ...
  function ih(e, r, t, a) {
    ...
    r.forEach(function (r) {
      ...
      if (!i) {
        ...
        var f = Pa(e["!ref"] || "BDWGO1000001:A1");
  ...
  function fh(e) {
    var r = [Br, At("comments", null, { xmlns: xt[0] })];
    var t = [];
    r.push("<authors>");
    e.forEach(function (e) {
    ...
    e.forEach(function (e) {
      ...
      if (n.length <= 1) r.push(kt("t", Qr(n[0] || "")));
      else {
        var i = "Comment:\n    " + n[0] + "\n";
  ...
  function lh(e, r, t) {
    var a = [
      Br,
      At("ThreadedComments", null, { xmlns: _t.TCMNT }).replace(/[\/]>/, ">"),
    ];
    e.forEach(function (e) {
      var n = "";
      (e[1] || []).forEach(function (i, s) {
        ...
        if (i.a)
          f.personId =
            ...
            "}";
        a.push(At("threadedComment", kt("text", i.t || ""), f));
      });
    });
  ...
  function hh(e) {
    var r = [
      Br,
      At("personList", null, { xmlns: _t.TCMNT, "xmlns:x": xt[0] }).replace(
        /[\/]>/,
        ">",
      ),
    ];
  ...
  function mh(e) {
    ...
    e.forEach(function (e) {
      e[1].forEach(function (a) {
        ...
        var n = { s: Ia(e[0]), e: Ia(e[0]) };
        ma(r, 635, dh([n, a]));
        if (a.t && a.t.length > 0) ma(r, 637, Ja(a));
        ma(r, 636);
        delete a.iauthor;
      });
    });
  ...
  function bu(e, r, t) {
    var a = e._R(t.biff == 12 ? 4 : 2);
    var n = [];
    for (var i = 0; i != a; ++i) n.push((t.biff == 12 ? dn : Os)(e, 8));
    return n;
  }
  function wu(e, r, t) {
    var a = 0,
  ...
  var Ju = {
    ...
    18: { n: "PtgUplus", f: Fh },
    19: { n: "PtgUminus", f: Fh },
    20: { n: "PtgPercent", f: Fh },
    21: { n: "PtgParen", f: Fh },
    22: { n: "PtgMissArg", f: Fh },
    23: { n: "PtgStr", f: gu },
    26: { n: "PtgSheet", f: ju },
  ...
  var Zu = {
    ...
    13: { n: "PtgElfColS", f: Fu },
    15: { n: "PtgElfColSV", f: Du },
  ...
  function hd(e, r, t) {
    ...
    var n,
      i = e._R(2);
    var s = rd(e, i, t);
    if (i == 65535) return [[], da(e, r - 2)];
    if (r !== i + 2) n = ed(e, a - i - 2, s, t);
    return [s, n];
  }
  function ud(e) {
    var r;
    if (ra(e, e.l + 6) !== 65535) return [pn(e), "n"];
    switch (e[e.l]) {
      case 0:
        e.l += 8;
        return ["String", "s"];
  ...
  function Pd(e, r, t, a, n, i) {
    ...
    if (e.t === "d" && typeof e.v === "string") e.v = br(e.v);
    if ((!a || a.cellText !== false) && e.t !== "z")
      try {
        if (X[r] == null) Ke(Ge[r] || "General", r);
        ...
        } else if (e.t === "d") e.w = Be(r, lr(e.v), Od);
  ...
  function Yd(e, r, t, a, n, i, s) {
    ...
    if (T)
      for (d = 0; d != T.length; ++d)
        k[d] = Pa(T[d].slice(T[d].indexOf('"') + 1));
    var A = c.match(Wd);
    if (A) tv(f, A, a);
    var E = c.match(Gd);
    if (E) f["!margins"] = av(Xr(E[0]));
    if (!f["!ref"] && o.e.c >= o.s.c && o.e.r >= o.s.r) f["!ref"] = Da(o);
  ...
  function Kd(e) {
    ...
    for (var t = 0; t != e.length; ++t)
      r += '<mergeCell ref="' + Da(e[t]) + '"/>';
    return r + "</mergeCells>";
  }
  function Jd(e, r, t, a) {
    var n = Xr(e);
    if (!t.Sheets[a]) t.Sheets[a] = {};
    if (n.codeName) t.Sheets[a].CodeName = Jr(ht(n.codeName));
  }
  ...
  function Zd(e, r, t, a, n) {
    ...
    if (e && e["!outline"]) {
      ...
      f = (f || "") + At("outlinePr", null, c);
    }
    if (!i && !f) return;
    n[n.length] = At("sheetPr", f, s);
  }
  ...
  function rv(e) {
    ...
    return At("sheetProtection", null, r);
  }
  function tv(e, r, t) {
    var a = Array.isArray(e);
    for (var n = 0; n != r.length; ++n) {
      var i = Xr(ht(r[n]), true);
      if (!i.ref) return;
      var s = ((t || {})["!id"] || [])[i.id];
      if (s) {
        i.Target = s.Target;
        if (i.location) i.Target += "#" + Jr(i.location);
      } else {
        i.Target = "#" + Jr(i.location);
  ...
  function nv(e) {
    Fd(e);
    return At("pageMargins", null, e);
  }
  function iv(e, r) {
    var t = false;
    for (var a = 0; a != r.length; ++a) {
      var n = Xr(r[a], true);
      if (n.hidden) n.hidden = st(n.hidden);
  ...
  function ov(e, r, t, a) {
    var n = typeof e.ref == "string" ? e.ref : Da(e.ref);
    ...
    return At("autoFilter", null, { ref: n });
  }
  ...
  function cv(e, r) {
    ...
    (e.match(lv) || []).forEach(function (e, t) {
      ...
      if (st(a.rightToLeft)) r.Views[t].RTL = true;
    });
  }
  function hv(e, r, t, a) {
    ...
    return At("sheetViews", At("sheetView", null, n), {});
  }
  function uv(e, r, t, a) {
    ...
    if (e.t !== "z")
      switch (e.t) {
        ...
        case "e":
          ...
          break;
        case "d":
          if (a && a.cellDates) n = br(e.v, -1).toISOString();
          else {
            e = kr(e);
            e.t = "n";
            n = "" + (e.v = lr(br(e.v)));
    ...
    switch (e.t) {
      ...
      default:
        ...
        if (a && a.bookSST) {
          f = kt("v", "" + Id(a.Strings, e.v, a.revStrings));
          o.t = "s";
          break;
        }
        o.t = "str";
    ...
    return function f(o, l, c, h, u, d) {
      ...
      for (var B = o.split(r), W = 0, H = B.length; W != H; ++W) {
        ...
        for (v = 0; v != g.length; ++v) {
          ...
          ++w;
          E = Xr(p.slice(0, w), true);
          if (!E.r) E.r = Na({ r: C - 1, c: y });
          T = p.slice(w);
          A = { t: "" };
          if ((m = T.match(i)) != null && m[1] !== "") A.v = Jr(m[1]);
          if (c.cellFormula) {
            if ((m = T.match(s)) != null && m[1] !== "") {
              A.f = Jr(ht(m[1])).replace(/\r\n/g, "\n");
              if (!c.xlfn) A.f = Nh(A.f);
              if (m[0].indexOf('t="array"') > -1) {
                A.F = (T.match(n) || [])[1];
                if (A.F.indexOf(":") > -1) N.push([Pa(A.F), A.F]);
              } else if (m[0].indexOf('t="shared"') > -1) {
                _ = Xr(m[0]);
                var j = Jr(ht(m[1]));
                if (!c.xlfn) j = Nh(j);
                F[parseInt(_.si, 10)] = [_, j, E.r];
              }
            } else if ((m = T.match(/<f[^>]*\/>/))) {
              _ = Xr(m[0]);
              if (F[_.si]) A.f = Rh(F[_.si][1], F[_.si][2], E.r);
            }
            var $ = Ia(E.r);
  ...
  function vv(e, r, t, a) {
    ...
    var p = { r: l },
      g,
      m = -1;
    for (u = s.s.c; u <= s.e.c; ++u) c[u] = _a(u);
  ...
  function pv(e, r, t, a) {
    var n = [Br, At("worksheet", null, { xmlns: xt[0], "xmlns:r": _t.r })];
    ...
    var h = [];
    Zd(o, t, e, r, n);
    n[n.length] = At("dimension", null, { ref: l });
    n[n.length] = hv(o, r, e, t);
    if (r.sheetFormat)
      n[n.length] = At("sheetFormatPr", null, {
    ...
    if (o["!links"].length > 0) {
      ...
      o["!links"].forEach(function (e) {
        ...
        n[n.length] = At("hyperlink", null, d);
      });
      n[n.length] = "</hyperlinks>";
    }
    delete o["!links"];
    ...
    if (!r || r.ignoreEC || r.ignoreEC == void 0)
      n[n.length] = kt(
        "ignoredErrors",
        At("ignoredError", null, { numberStoredAsText: 1, sqref: l }),
      );
    if (h.length > 0) {
      v = ri(a, -1, "../drawings/drawing" + (e + 1) + ".xml", qn.DRAW);
      n[n.length] = At("drawing", null, { "r:id": "rId" + v });
      o["!drawing"] = h;
    }
    if (o["!comments"].length > 0) {
      v = ri(a, -1, "../drawings/vmlDrawing" + (e + 1) + ".vml", qn.VML);
      n[n.length] = At("legacyDrawing", null, { "r:id": "rId" + v });
      o["!legacy"] = v;
    }
    if (n.length > 1) {
  ...
  function mv(e, r, t) {
    ...
    for (var c = 0; c < 16; ++c) {
      ...
      for (var d = c << 10; d < (c + 1) << 10; ++d) {
        l.c = d;
        var v = Array.isArray(t) ? (t[l.r] || [])[l.c] : t[Na(l)];
        if (v) {
          if (h < 0) h = d;
          u = d;
        }
  ...
  function bv(e, r, t, a) {
    var n = mv(a, t, r);
    if (n.length > 17 || (r["!rows"] || [])[a]) ma(e, 0, n);
  }
  var wv = dn;
  var kv = vn;
  function Tv() {}
  ...
  function Jv(e, r, t) {
    if (t == null) t = va(12 + 4 * e.v.length);
    Za(r, t);
    Ga(e.v, t);
  ...
  function fp(e, r) {
    var t = va(50 + 4 * (e[1].Target.length + (e[1].Tooltip || "").length));
    vn({ s: Ia(e[0]), e: Ia(e[0]) }, t);
    on("rId" + r, t);
      ...
      function M(e, r, g) {
        ...
        switch (g) {
          ...
          case 62:
            ...
            if (c.e.c < w) c.e.c = w;
            if (f.cellDates && m && p.t == "n" && De(X[m.numFmtId])) {
              var L = q(p.v);
              if (L) {
                p.t = "d";
  ...
  function Ap(e, r, t, a, n, i, s) {
    ...
    if (r.l) i["!links"].push([Na(o), r.l]);
    if (r.c) i["!comments"].push([Na(o), r.c]);
    switch (r.t) {
      case "s":
      case "str":
        if (n.bookSST) {
  ...
  function Op(e, r, t, a) {
    ...
    var n = r["!autofilter"];
    var i = typeof n.ref === "string" ? n.ref : Da(n.ref);
    if (!t.Workbook) t.Workbook = { Sheets: [] };
    if (!t.Workbook.Names) t.Workbook.Names = [];
  ...
  function Fp(e, r, t, a) {
    ...
    s["!comments"] = [];
    ma(n, 129);
    if (t.vbaraw || s["!outline"]) ma(n, 147, Ev(f, s["!outline"]));
    ma(n, 148, kv(l));
    Rp(n, s, t.Workbook);
    Ip(n, s);
    yp(n, s, e, r, t);
    ...
    Cp(n, s);
    _p(n, s, a);
    if (s["!margins"]) ma(n, 476, vp(s["!margins"]));
    ...
    for (var t = 0; t != e.length; ++t) {
      ...
      for (var n = 0; n != r.length; ++n) {
        ...
        if (a[i[0]] == null) a[i[0]] = i[1];
          ...
          switch (i[2]) {
            case "bool":
              if (typeof a[i[0]] == "string") a[i[0]] = st(a[i[0]]);
              break;
            case "int":
  ...
  function Gp(e, r) {
    for (var t = 0; t != r.length; ++t) {
      ...
      if (e[a[0]] == null) e[a[0]] = a[1];
        ...
        switch (a[2]) {
          case "bool":
            if (typeof e[a[0]] == "string") e[a[0]] = st(e[a[0]]);
            break;
          case "int":
  ...
  function jp(e) {
    ...
    Vp(e.WBView, Wp);
    Vp(e.Sheets, Hp);
    Od.date1904 = st(e.WBProps.date1904);
  }
  function Xp(e) {
    if (!e.Workbook) return "false";
    if (!e.Workbook.WBProps) return "false";
    return st(e.Workbook.WBProps.date1904) ? "true" : "false";
  }
  var $p = "][*?/\\".split("");
  function Yp(e, r) {
    if (e.length > 31) {
    ...
    e.replace(Vr, function f(o, l) {
      ...
      switch ($r(c[0])) {
        ...
        case "<workbookPr/>":
          ...
          if (c.codeName) t.WBProps.CodeName = ht(c.codeName);
          break;
        case "</workbookPr>":
          break;
        ...
        case "<definedName":
          {
            ...
            if (st(c.hidden || "0")) i.Hidden = true;
            s = l + o.length;
          }
          break;
        case "</definedName>":
          {
            i.Ref = Jr(ht(e.slice(s, l)));
            t.Names.push(i);
          }
          break;
        case "<definedName/>":
  ...
  function Qp(e) {
    var r = [Br];
    r[r.length] = At("workbook", null, { xmlns: xt[0], "xmlns:r": _t.r });
    ...
    r[r.length] = At("workbookPr", null, a);
    ...
    if (t) {
      ...
      if (e.Workbook && e.Workbook.Names)
        e.Workbook.Names.forEach(function (e) {
          ...
          if (!e.Ref) return;
          r[r.length] = At("definedName", Qr(e.Ref), t);
        });
      r[r.length] = "</definedNames>";
    }
    if (r.length > 2) {
  ...
  function ag(e, r) {
    ...
    r._W(4, t);
    r._W(4, 0);
    tn((e && e.CodeName) || "ThisWorkbook", r);
    return r.slice(0, r.l);
  }
  function ng(e, r) {
    var t = {};
  ...
  function hg(e, r) {
    ...
    ma(t, 131);
    ma(t, 128, og());
    ma(t, 153, ag((e.Workbook && e.Workbook.WBProps) || null));
    cg(t, e, r);
    fg(t, e, r);
    ma(t, 132);
    return t.end();
  ...
  function ug(e, r, t) {
    if (r.slice(-4) === ".bin") return sg(e, t);
    return Zp(e, t);
  }
  function dg(e, r, t, a, n, i, s, f) {
    if (r.slice(-4) === ".bin") return Tp(e, a, t, n, i, s, f);
    return Yd(e, a, t, n, i, s, f);
  }
  function vg(e, r, t, a, n, i, s, f) {
    if (r.slice(-4) === ".bin") return Up(e, a, t, n, i, s, f);
  ...
  function Rg(e, r, t) {
    ...
    if (!t || t.cellText !== false)
      try {
        ...
        } else e.w = xg(r || "General", e.v);
      } catch (a) {
        if (t.WTF) throw a;
      }
    try {
      var n = _g[r] || r || "General";
      if (t.cellNF) e.z = n;
  ...
  function Ng(e, r, t, a, n, i, s, f, o, l) {
    var c = "General",
      h = a.StyleID,
      u = {};
    l = l || {};
    ...
    switch (t.Type) {
      ...
      case "String":
        a.t = "s";
        a.r = nt(Jr(e));
        a.v = e.indexOf("<") > -1 ? Jr(r || e).replace(/<.*?>/g, "") : a.r;
        break;
      case "DateTime":
        if (e.slice(-1) != "Z") e += "Z";
        a.v = (br(e) - new Date(Date.UTC(1899, 11, 30))) / (24 * 60 * 60 * 1e3);
        if (a.v !== a.v) a.v = Jr(e);
    ...
    while ((o = St.exec(n)))
      switch ((o[3] = ($ = o[3]).toLowerCase())) {
        ...
        case "style":
          ...
          break;
        case "numberformat":
          S.nf = Jr(yg(o[0]).Format || "General");
          if (_g[S.nf]) S.nf = _g[S.nf];
        ...
        case "column":
          ...
          for (var Z = 0; Z < +M.Span; ++Z) L[L.length] = kr(M);
          break;
        case "namedrange":
          if (o[1] === "/") break;
          if (!G.Names) G.Names = [];
        ...
        case "null":
          break;
        default:
          if (l.length == 0 && o[3] == "document") return Vm(n, t);
          if (l.length == 0 && o[3] == "uof") return Vm(n, t);
          var te = true;
            ...
            case "worksheetoptions":
              switch (o[3]) {
                ...
                case "header":
                  ...
                  if (!isNaN(+Xr(o[0]).Margin))
                    p["!margins"].header = +Xr(o[0]).Margin;
                  break;
                case "footer":
                  if (!p["!margins"]) Fd((p["!margins"] = {}), "xlml");
                  if (!isNaN(+Xr(o[0]).Margin))
                    p["!margins"].footer = +Xr(o[0]).Margin;
                  break;
                case "pagemargins":
                  var ae = Xr(o[0]);
                  if (!p["!margins"]) Fd((p["!margins"] = {}), "xlml");
          ...
          if (l[l.length - 1][0] === "customdocumentproperties") {
            if (o[0].slice(-2) === "/>") break;
            else if (o[1] === "/") Og(I, $, F, n.slice(N, o.index));
            else {
              F = o;
  ...
  function Ug(e, r) {
    ...
    r.cellXfs.forEach(function (e, r) {
      var a = [];
      a.push(At("NumberFormat", null, { "ss:Format": Qr(X[e.numFmtId]) }));
      var n = { "ss:ID": "s" + (21 + r) };
      t.push(At("Style", a.join(""), n));
    });
    return At("Styles", t.join(""));
  }
  function Bg(e) {
    return At("NamedRange", null, {
      "ss:Name": e.Name,
  ...
  function zg(e, r, t, a) {
    ...
    if (e["!margins"]) {
      n.push("<PageSetup>");
      if (e["!margins"].header)
        n.push(At("Header", null, { "x:Margin": e["!margins"].header }));
      if (e["!margins"].footer)
        n.push(At("Footer", null, { "x:Margin": e["!margins"].footer }));
      n.push(
        At("PageMargins", null, {
    ...
    if (e["!protect"]) {
      n.push(kt("ProtectContents", "True"));
      if (e["!protect"].objects) n.push(kt("ProtectObjects", "True"));
      if (e["!protect"].scenarios) n.push(kt("ProtectScenarios", "True"));
      if (
        e["!protect"].selectLockedCells != null &&
        !e["!protect"].selectLockedCells
      )
        n.push(kt("EnableSelection", "NoSelection"));
      else if (
        e["!protect"].selectUnlockedCells != null &&
        !e["!protect"].selectUnlockedCells
      )
        n.push(kt("EnableSelection", "UnlockedCells"));
      [
    ...
    return At("WorksheetOptions", n.join(""), { xmlns: Ot.x });
  }
  function Vg(e) {
    return e
      .map(function (e) {
        var r = it(e.t || "");
        var t = At("ss:Data", r, { xmlns: "http://www.w3.org/TR/REC-html40" });
        return At("Comment", t, { "ss:Author": e.a });
      })
      .join("");
  }
  function Gg(e, r, t, a, n, i, s) {
    if (!e || (e.v == undefined && e.f == undefined)) return "";
    var f = {};
    if (e.f) f["ss:Formula"] = "=" + Qr(xh(e.f, s));
    if (e.F && e.F.slice(0, r.length) == r) {
      var o = Ia(e.F.slice(r.length + 1));
      f["ss:ArrayRange"] =
        "RC:R" +
        (o.r == s.r ? "" : "[" + (o.r - s.r) + "]") +
        "C" +
  ...
  function Yg(e, r) {
    ...
    for (var a = 0; a < e.SheetNames.length; ++a)
      t.push(At("Worksheet", $g(a, r, e), { "ss:Name": Qr(e.SheetNames[a]) }));
    t[2] = Ug(e, r);
    t[3] = Wg(e, r);
    return (
      Br +
  ...
  function Kg(e) {
    ...
    r.UnicodeClipboardFormat = En(t);
    a = t._R(4);
    if (a == 0 || a > 40) return r;
    t.l -= 4;
    r.Reserved2 = t._R(0, "lpwstr");
  }
  var Jg = [60, 1084, 2066, 2165, 2175];
  function qg(e, r, t, a, n) {
    var i = a;
    var s = [];
          ...
          case 536:
            ...
            if (q.Name == "_xlnm._FilterDatabase" && q.itab > 0)
              if (
                ...
                z[q.itab - 1] = { ref: Da(q.rgce[0][0][1][2]) };
            break;
          case 22:
            R.ExternCount = q;
            break;
          ...
          case 1212:
            {
              ...
              if (d) {
                if (!f) break;
                w[Na(f.cell)] = q[0];
                v = r.dense ? (n[f.cell.r] || [])[f.cell.c] : n[Na(f.cell)];
                (v || {}).f = "" + fd(q[0], s, u, M, R);
              }
            }
            break;
          case 253:
            T = Qg(l[q.isst].t, q.ixfe, "s");
          ...
          case 28:
            {
              ...
              v = r.dense ? (n[q[0].r] || [])[q[0].c] : n[Na(q[0])];
              var ue = F[q[2]];
              if (!v) {
                if (r.dense) {
                  if (!n[q[0].r]) n[q[0].r] = [];
  ...
  function am(e, r) {
    ...
    if (a.length)
      qe.utils.cfb_add(r, "/SummaryInformation", Yi(a, rm.SI, o, Un));
    if (t.length || l.length)
      qe.utils.cfb_add(
        r,
        "/DocumentSummaryInformation",
        Yi(t, rm.DSI, f, Mn, l.length ? l : null, rm.UDI),
      );
  }
  function nm(e, r) {
    if (!r) r = {};
    ...
    if (r.bookProps && !r.bookSheets) n = {};
      ...
      if (a && a.content) n = em(a.content, r);
      else if ((i = qe.find(e, "PerfectOffice_MAIN")) && i.content)
        n = xo.to_workbook(i.content, ((r.type = f), r));
      else if ((i = qe.find(e, "NativeContent_MAIN")) && i.content)
        n = xo.to_workbook(i.content, ((r.type = f), r));
      else if ((i = qe.find(e, "MN0")) && i.content)
        throw new Error("Unsupported Works 4 for Mac file");
      else throw new Error("Cannot find Workbook stream");
      if (r.bookVBA && e.FullPaths && qe.find(e, "/_VBA_PROJECT_CUR/VBA/dir"))
        n.vbaraw = wh(e);
    }
    var o = {};
    if (e.FullPaths) tm(e, o, r);
  ...
  function im(e, r) {
    ...
    qe.utils.cfb_add(a, n, Sm(e, t));
    if (t.biff == 8 && (e.Props || e.Custprops)) am(e, a);
  ...
  function om(e, r, t, a) {
    ...
    s._W(2, n);
    s._W(2, i);
    if (i > 0 && Zt(t)) e.push(t);
  }
  function lm(e, r, t, a) {
    var n = a || (t || []).length || 0;
    if (n <= 8224) return om(e, r, t, n);
    var i = r;
    if (isNaN(i)) return;
    var s = t.parts || [],
      f = 0;
  ...
  function dm(e, r, t, a) {
    if (r.v != null)
      switch (r.t) {
        case "d":
        case "n":
          var n = r.t == "d" ? lr(br(r.v)) : r.v;
          if (n == (n | 0) && n >= 0 && n < 65536) om(e, 2, mo(t, a, n));
          else om(e, 3, po(t, a, n));
          return;
        case "b":
        case "e":
          om(e, 5, hm(t, a, r.v, r.t));
          return;
        case "s":
        case "str":
          om(e, 4, um(t, a, (r.v || "").slice(0, 255)));
          return;
      }
    om(e, 1, cm(null, t, a));
  }
  ...
  function pm(e, r) {
    ...
    om(a, t.biff == 4 ? 1033 : t.biff == 3 ? 521 : 9, Ws(e, 16, t));
    vm(a, e.Sheets[e.SheetNames[n]], n, t, e);
    om(a, 10);
    return a.end();
  }
  function gm(e, r, t) {
  ...
  function mm(e, r, t) {
    ...
    [
      ...
      for (var n = a[0]; n <= a[1]; ++n)
        if (r[n] != null) om(e, 1054, df(n, r[n], t));
    });
  }
  function bm(e, r) {
    var t = va(19);
  ...
  function wm(e, r) {
    for (var t = 0; t < 16; ++t)
      om(e, 224, Af({ numFmtId: 0, style: true }, 0, r));
  ...
  function Tm(e, r) {
    ...
    r.forEach(function (r, a) {
      if (++t <= 256 && r) {
        om(e, 125, no(Nd(a, r), a));
      }
    });
  }
  function Am(e, r, t, a, n) {
    var i = 16 + Dd(n.cellXfs, r, n);
    if (r.v == null && !r.bf) {
      om(e, 513, Es(t, a, i));
      return;
    }
    if (r.bf) om(e, 6, pd(r, t, a, n, i));
    else
      switch (r.t) {
        case "d":
        case "n":
          var s = r.t == "d" ? lr(br(r.v)) : r.v;
          om(e, 515, xf(t, a, s, i, n));
          break;
        case "b":
        case "e":
          om(e, 517, Sf(t, a, r.v, i, n, r.t));
          break;
        case "s":
        case "str":
          if (n.bookSST) {
            var f = Id(n.Strings, r.v, n.revStrings);
            om(e, 253, lf(t, a, f, i, n));
          } else om(e, 516, hf(t, a, (r.v || "").slice(0, 255), i, n));
          break;
        default:
          om(e, 513, Es(t, a, i));
      }
  ...
  function Em(e, r, t) {
    ...
    if (l) om(a, 574, af((s.Views || [])[0]));
    if (l && (i["!merges"] || []).length) om(a, 229, Vf(i["!merges"]));
    if (l) km(a, i);
    om(a, 442, hs(b, r));
    if (l) bm(a, i);
    om(a, 10);
  ...
  function Cm(e, r, t) {
    ...
    var f = t.biff == 8,
      o = t.biff == 5;
    om(a, 2057, Ws(e, 5, t));
    if (t.bookType == "xla") om(a, 135);
    om(a, 225, f ? rs(1200) : null);
    om(a, 193, Ji(2));
    if (o) om(a, 191);
    if (o) om(a, 192);
    om(a, 226);
    om(a, 92, Vs("SheetJS", t));
    om(a, 66, rs(f ? 1200 : 1252));
    if (f) om(a, 353, rs(0));
    if (f) om(a, 448);
    om(a, 317, fo(e.SheetNames.length));
    if (f && e.vbaraw) om(a, 211);
    if (f && e.vbaraw) {
    ...
    om(a, 18, Qi(false));
    om(a, 19, rs(0));
    if (f) om(a, 431, Qi(false));
    if (f) om(a, 444, rs(0));
    om(a, 61, rf(t));
    om(a, 64, Qi(false));
    om(a, 141, rs(0));
    om(a, 34, Qi(Xp(e) == "true"));
    om(a, 14, Qi(true));
    if (f) om(a, 439, Qi(false));
    om(a, 218, rs(0));
    gm(a, e, t);
    mm(a, e.SSF, t);
    wm(a, t);
    if (f) om(a, 352, Qi(false));
    var c = a.end();
    var h = ga();
    if (f) om(h, 140, Qf());
    if (f && t.Strings) lm(h, 252, Ys(t.Strings, t));
    om(h, 10);
    var u = h.end();
    var d = ga();
    var v = 0,
  ...
  function ym(e, r) {
    ...
    Fb(t);
    t.cellXfs = [];
    Dd(t.cellXfs, {}, { revssf: { General: 0 } });
    if (!e.Props) e.Props = {};
    for (var n = 0; n < e.SheetNames.length; ++n) a[a.length] = Em(n, t, e);
    a.unshift(Cm(e, a, t));
    return R(a);
  }
  function Sm(e, r) {
  ...
  function _m(e, r) {
    ...
    for (s = 0; s < o.length; ++s) {
      ...
      for (f = 0; f < b.length; ++f) {
        ...
        else if (!isNaN(Ar(k))) S = { t: "n", v: Ar(k) };
        else if (!isNaN(Cr(k).getDate())) {
          S = { t: "d", v: br(k) };
          if (!t.cellDates) S = { t: "n", v: lr(S.v) };
          S.z = t.dateNF || X[14];
        }
        if (t.dense) {
          if (!a[l]) a[l] = [];
  ...
  function xm(e, r, t, a) {
    ...
    for (var s = r.s.c; s <= r.e.c; ++s) {
      ...
      var u =
        (h && h.v != null && (h.h || tt(h.w || (Ma(h), h.w) || ""))) || "";
      var d = {};
      if (f > 1) d.rowspan = f;
      if (o > 1) d.colspan = o;
  ...
  function Im(e, r) {
    ...
    if (t.length == 1) return Ua(_m(t[0], r), r);
    var a = Cw();
    t.forEach(function (e, t) {
      yw(a, _m(e, r), "Sheet" + (t + 1));
    });
    return a;
  }
  function Nm(e, r, t) {
  ...
  function Fm(e, r) {
    var t = r || {};
    var a = t.header != null ? t.header : Om;
    var n = t.footer != null ? t.footer : Rm;
    var i = [a];
    var s = Fa(e["!ref"]);
    t.dense = Array.isArray(e);
    i.push(Nm(e, s, t));
    for (var f = s.s.r; f <= s.e.r; ++f) i.push(xm(e, s, f, t));
    i.push("</table>" + n);
    return i.join("");
  }
  function Dm(e, r, t) {
    ...
    if (a.origin != null) {
      if (typeof a.origin == "number") n = a.origin;
        ...
        var s = typeof a.origin == "string" ? Ia(a.origin) : a.origin;
        n = s.r;
        i = s.c;
      }
    }
    ...
    for (; v < f.length && p < o; ++v) {
      ...
      for (m = b = 0; m < A.length; ++m) {
        ...
        if (C != null) {
          ...
          else if (!isNaN(Ar(C))) _ = { t: "n", v: Ar(C) };
          else if (!isNaN(Cr(C).getDate())) {
            _ = { t: "d", v: br(C) };
            if (!a.cellDates) _ = { t: "n", v: lr(_.v) };
            _.z = a.dateNF || X[14];
          }
        }
    ...
    e["!ref"] = Da(l);
    if (p >= o) e["!fullref"] = Da(((l.e.r = f.length - v + p - 1 + n), l));
    return e;
  }
  function Pm(e, r) {
    var t = r || {};
  ...
  function Hm(e, r) {
    ...
    while ((p = St.exec(a)))
      switch ((p[3] = p[3].replace(/_.*$/, ""))) {
        ...
        case "工作表":
          if (p[1] === "/") {
            if (y.e.c >= y.s.c && y.e.r >= y.s.r) v["!ref"] = Da(y);
            else v["!ref"] = "A1:A1";
        ...
        case "行":
          ...
          F = +h["number-rows-repeated"] || 1;
          if (F < 10)
            for (j = 0; j < F; ++j) if (S > 0) N[E + j] = { level: S };
          C = -1;
          break;
        ...
        case "数据":
          if (p[0].charAt(p[0].length - 2) === "/") {
            ++C;
            b = Xr(p[0], false);
            D = parseInt(b["number-columns-repeated"] || "1", 10);
            m = { t: "z", v: null };
            if (b.formula && t.cellFormula != false) m.f = Cd(Jr(b.formula));
            if ((b["数据类型"] || b["value-type"]) == "string") {
              m.t = "s";
              m.v = Jr(b["string-value"] || "");
              if (t.dense) {
                if (!v[E]) v[E] = [];
                v[E][C] = m;
              } else {
            ...
            if (t.cellFormula) {
              if (b.formula) b.formula = Jr(b.formula);
              if (
            ...
            if (b["number-columns-repeated"])
              D = parseInt(b["number-columns-repeated"], 10);
            switch (m.t) {
              case "boolean":
                m.t = "b";
                m.v = st(b["boolean-value"]);
                break;
              case "float":
                m.t = "n";
              ...
              if (!(t.sheetRows && t.sheetRows <= E)) {
                for (var $ = 0; $ < F; ++$) {
                  ...
                  if (t.dense) {
                    if (!v[E + $]) v[E + $] = [];
                    v[E + $][C] = $ == 0 ? m : kr(m);
                    while (--D > 0) v[E + $][C + D] = kr(m);
                  } else {
                    v[Na({ r: E + $, c: C })] = m;
                    while (--D > 0) v[Na({ r: E + $, c: C + D })] = kr(m);
                  }
                  if (y.e.c <= C) y.e.c = C;
                }
              }
        ...
        case "database-range":
          if (p[1] === "/") break;
          try {
            U = Sd(Xr(p[0])["target-range-address"]);
  ...
  function zm(e, r) {
    r = r || {};
    if (Or(e, "META-INF/manifest.xml")) ai(Ir(e, "META-INF/manifest.xml"), r);
    var t = Nr(e, "content.xml");
    if (!t) throw new Error("Missing content.xml in ODS / UOF file");
    var a = Hm(ht(t), r);
    if (Or(e, "meta.xml")) a.Props = hi(Ir(e, "meta.xml"));
    return a;
  }
  function Vm(e, r) {
    return Hm(e, r);
        ...
        for (; o <= l.e.c; ++o) {
          ...
          switch (w.t) {
            ...
            case "str":
              ...
              break;
            case "d":
              m = w.w || br(w.v).toISOString();
              g["office:value-type"] = "date";
              g["office:date-value"] = br(w.v).toISOString();
          ...
          if (w.l && w.l.Target) {
            ...
            T = At("text:a", T, { "xlink:href": A.replace(/&/g, "&amp;") });
          }
          s.push(
            "          " +
              At("table:table-cell", At("text:p", T, {}), g) +
              "\n",
          );
        }
  ...
  function Xm(e, r) {
    if (r.bookType == "fods") return jm(e, r);
    var t = Lr();
    var a = "";
    var n = [];
    var i = [];
    a = "mimetype";
    Pr(t, a, "application/vnd.oasis.opendocument.spreadsheet");
    a = "content.xml";
    Pr(t, a, jm(e, r));
    n.push([a, "text/xml"]);
  ...
  function eb(e, r, t) {
    var a =
      Math.floor(t == 0 ? 0 : Math.LOG10E * Math.log(Math.abs(t))) + 6176 - 16;
  ...
  function ib(e) {
    ...
    e.forEach(function (e, t) {
      ...
      e.forEach(function (e) {
        if (!e.data) return;
        r.push(tb(t * 8 + e.type));
        if (e.type == 2) r.push(tb(e.data.length));
        r.push(e.data);
      });
    });
    return qm(r);
  ...
  function fb(e) {
    ...
    while (a[0] < e.length) {
      var n = rb(e, a);
      var i = nb(e.slice(a[0], a[0] + n));
      a[0] += n;
      var s = { id: ab(i[1][0].data), messages: [] };
  ...
  function ob(e) {
    var r = [];
    e.forEach(function (e) {
      var t = [[], [{ data: tb(e.id), type: 0 }], []];
      if (e.merge != null) t[3] = [{ data: tb(+!!e.merge), type: 0 }];
      var a = [];
      e.messages.forEach(function (e) {
        a.push(e.data);
        e.meta[3] = [{ type: 0, data: tb(e.data.length) }];
        t[2].push({ data: ib(e.meta), type: 2 });
      });
      var n = ib(t);
      r.push(tb(n.length));
      r.push(n);
  ...
  function ub(e, r, t, a) {
    ...
    var s = (a > 1 ? 12 : 8) + Zm(i & (a > 1 ? 3470 : 398)) * 4;
    var f = -1,
      o = -1,
      l = NaN,
      c = new Date(2001, 0, 1);
  ...
  function mb(e) {
    var r = nb(e);
    return rb(r[1][0].data);
  }
  function bb(e) {
    return ib([[], [{ type: 0, data: tb(e) }]]);
  }
  function wb(e, r) {
    var t = nb(r.data);
    var a = ab(t[1][0].data);
    ...
    (n || []).forEach(function (r) {
      ...
      switch (a) {
        ...
        case 8:
          {
            var s = e[mb(t[9][0].data)][0];
            var f = nb(s.data);
            var o = e[mb(f[1][0].data)][0];
            var l = ab(o.meta[1][0].data);
            if (l != 2001)
  ...
  function kb(e, r) {
    ...
    var g = nb(e);
    var m = ab(g[1][0].data) >>> 0;
    var b = ab(g[2][0].data) >>> 0;
    var w =
  ...
  function Tb(e, r) {
    ...
    if ((t = a == null ? void 0 : a[7]) == null ? void 0 : t[0]) {
      if (ab(a[7][0].data) >>> 0) n = 1;
      else n = 0;
    }
    var i = sb(a[5], function (e) {
      return kb(e, n);
    });
    return {
      nrows: ab(a[4][0].data) >>> 0,
  ...
  function Ab(e, r, t) {
    var a, n, i;
    var s = nb(r.data);
    var f = { s: { r: 0, c: 0 }, e: { r: 0, c: 0 } };
    f.e.r = (ab(s[6][0].data) >>> 0) - 1;
    if (f.e.r < 0) throw new Error("Invalid row varint ".concat(s[6][0].data));
    f.e.c = (ab(s[7][0].data) >>> 0) - 1;
    if (f.e.c < 0) throw new Error("Invalid col varint ".concat(s[7][0].data));
    t["!ref"] = Da(f);
    var o = nb(s[4][0].data);
    var l = wb(e, e[mb(o[4][0].data)][0]);
    var c = ((a = o[17]) == null ? void 0 : a[0])
      ? wb(e, e[mb(o[17][0].data)][0])
      : [];
    var h = nb(o[3][0].data);
    var u = 0;
    h[1].forEach(function (r) {
      var a = nb(r.data);
      var n = e[mb(a[2][0].data)][0];
      var i = ab(n.meta[1][0].data);
    ...
    if ((n = o[13]) == null ? void 0 : n[0]) {
      var d = e[mb(o[13][0].data)][0];
      var v = ab(d.meta[1][0].data);
      if (v != 6144)
        throw new Error("Expected merge type 6144, found ".concat(v));
      t["!merges"] =
        (i = nb(d.data)) == null
          ? void 0
          : i[1].map(function (e) {
              var r = nb(e.data);
              var t = $m(nb(r[1][0].data)[1][0].data),
                a = $m(nb(r[2][0].data)[1][0].data);
              return {
                s: { r: t.getUint16(0, true), c: t.getUint16(2, true) },
                e: {
  ...
  function Eb(e, r) {
    var t = nb(r.data);
    var a = { "!ref": "A1" };
    var n = e[mb(t[2][0].data)];
    var i = ab(n[0].meta[1][0].data);
  ...
  function Cb(e, r) {
    ...
    var a = nb(r.data);
    var n = {
      name: ((t = a[1]) == null ? void 0 : t[0]) ? Ym(a[1][0].data) : "",
      sheets: [],
    };
    var i = sb(a[2], mb);
    i.forEach(function (r) {
      e[r].forEach(function (r) {
        var t = ab(r.meta[1][0].data);
        if (t == 6e3) n.sheets.push(Eb(e, r));
      });
    });
    return n;
  }
      ...
      e[r].forEach(function (r) {
        ...
        if (t == 2) {
          ...
          n.sheets.forEach(function (e, r) {
            yw(a, e, r == 0 ? n.name : n.name + "_" + r, true);
          });
        }
      });
    });
  ...
  function Sb(e) {
    ...
    if (
      ((n =
        (a =
          (t = (r = l == null ? void 0 : l[1]) == null ? void 0 : r[0]) == null
            ? void 0
            : t.meta) == null
          ? void 0
          : a[1]) == null
        ? void 0
        : n[0].data) &&
      ab(l[1][0].meta[1][0].data) == 1e4
    )
      throw new Error("Pages documents are not supported");
    var h =
      ((o =
        (f =
          (s = (i = l == null ? void 0 : l[1]) == null ? void 0 : i[0]) == null
            ? void 0
            : s.meta) == null
          ? void 0
          : f[1]) == null
        ? void 0
        : o[0].data) &&
      ab(l[1][0].meta[1][0].data) == 1 &&
      l[1][0];
    if (!h)
      c.forEach(function (e) {
        l[e].forEach(function (e) {
          var r = ab(e.meta[1][0].data) >>> 0;
          if (r == 1) {
            if (!h) h = e;
    ...
    if (!h) throw new Error("Cannot find Document root");
    return yb(l, h);
  }
  function _b(e, r, t, a) {
    var n, i;
    if (
      !((n = e[6]) == null ? void 0 : n[0]) ||
      !((i = e[7]) == null ? void 0 : i[0])
    )
    ...
    for (var g = 0; g < r.length; ++g) {
      if (r[g] == null) {
        l.setUint16(g * 2, 65535, true);
        u.setUint16(g * 2, 65535);
        continue;
      }
      l.setUint16(g * 2, c / p, true);
      u.setUint16(g * 2, d / p, true);
      var m, b;
      switch (typeof r[g]) {
        case "string":
          m = vb({ t: "s", v: r[g] }, t);
        ...
        case "boolean":
          ...
          break;
        default:
          throw new Error("Unsupported value " + r[g]);
      }
      h.push(m);
      c += m.length;
      {
    ...
    e[2][0].data = tb(s);
    e[5][0].data = tb(5);
    for (; g < e[7][0].data.length / 2; ++g) {
      l.setUint16(g * 2, 65535, true);
      u.setUint16(g * 2, 65535, true);
    }
    e[6][0].data = qm(h);
    e[3][0].data = qm(v);
    e[8] = [{ type: 0, data: tb(a ? 1 : 0) }];
    return s;
  }
  function xb(e, r) {
    return { meta: [[], [{ type: 0, data: tb(e) }]], data: r };
  }
  var Ob = true;
  function Rb(e, r) {
    var t;
    ...
    if (i)
      console.error(
        "The Numbers writer is currently limited to ".concat(Da(n)),
      );
    var s = vw(a, { range: n, header: 1 });
    var f = ["~Sh33tJ5~"];
    ...
    var o = {};
    var l = [];
    var c = qe.read(r.numbers, { type: "base64" });
    c.FileIndex.map(function (e, r) {
      ...
      i.forEach(function (e) {
        ...
        o[e.id] = {
          deps: [],
          location: t,
          type: ab(e.messages[0].meta[1][0].data),
        };
      });
    });
    l.sort(function (e, r) {
    ...
    c.FileIndex.map(function (e, r) {
      ...
      var r = e[0];
      if (!r.name.match(/\.iwa/)) return;
      var t = fb(cb(r.content));
      t.forEach(function (e) {
        h.forEach(function (r) {
          if (
            e.messages.some(function (e) {
              return ab(e.meta[1][0].data) != 11006 && Jm(e.data, r[1]);
            })
          ) {
    ...
    var d = qe.find(c, o[1].location);
    var v = fb(cb(d.content));
    var p;
    for (var g = 0; g < v.length; ++g) {
      var m = v[g];
      if (m.id == 1) p = m;
    }
    var b = mb(nb(p.messages[0].data)[1][0].data);
    d = qe.find(c, o[b].location);
    v = fb(cb(d.content));
    for (g = 0; g < v.length; ++g) {
      m = v[g];
      if (m.id == b) p = m;
    }
    var w = nb(p.messages[0].data);
    {
      w[1] = [{ type: 2, data: Km(e.SheetNames[0]) }];
    }
    p.messages[0].data = ib(w);
    d.content = hb(ob(v));
    ...
    b = mb(nb(p.messages[0].data)[2][0].data);
    d = qe.find(c, o[b].location);
    v = fb(cb(d.content));
    for (g = 0; g < v.length; ++g) {
      m = v[g];
    ...
    var k = nb(p.messages[0].data);
    {
      k[6][0].data = tb(n.e.r + 1);
      k[7][0].data = tb(n.e.c + 1);
      var T = mb(k[46][0].data);
      var A = qe.find(c, o[T].location);
      var E = fb(cb(A.content));
      {
        for (var C = 0; C < E.length; ++C) {
          if (E[C].id == T) break;
        }
        if (E[C].id != T) throw "Bad ColumnRowUIDMapArchive";
        var y = nb(E[C].messages[0].data);
        y[1] = [];
        ((y[2] = []), (y[3] = []));
        for (var S = 0; S <= n.e.c; ++S) {
          y[1].push({
            type: 2,
            data: ib([
              [],
              [{ type: 0, data: tb(S + 420690) }],
              [{ type: 0, data: tb(S + 420690) }],
            ]),
          });
          y[2].push({ type: 0, data: tb(S) });
          y[3].push({ type: 0, data: tb(S) });
        }
        y[4] = [];
        ((y[5] = []), (y[6] = []));
        for (var _ = 0; _ <= n.e.r; ++_) {
          y[4].push({
            type: 2,
            data: ib([
              [],
              [{ type: 0, data: tb(_ + 726270) }],
              [{ type: 0, data: tb(_ + 726270) }],
            ]),
          });
          y[5].push({ type: 0, data: tb(_) });
          y[6].push({ type: 0, data: tb(_) });
        }
        E[C].messages[0].data = ib(y);
      }
      A.content = hb(ob(E));
      ...
      var x = nb(k[4][0].data);
      {
        x[7][0].data = tb(n.e.r + 1);
        var O = nb(x[1][0].data);
        var R = mb(O[2][0].data);
        A = qe.find(c, o[R].location);
        E = fb(cb(A.content));
        {
          if (E[0].id != R) throw "Bad HeaderStorageBucket";
          var I = nb(E[0].messages[0].data);
          if ((t = I == null ? void 0 : I[2]) == null ? void 0 : t[0])
            for (_ = 0; _ < s.length; ++_) {
              var N = nb(I[2][0].data);
              N[1][0].data = tb(_);
              N[4][0].data = tb(s[_].length);
              I[2][_] = { type: I[2][0].type, data: ib(N) };
            }
          E[0].messages[0].data = ib(I);
        }
        A.content = hb(ob(E));
        A.size = A.content.length;
        var F = mb(x[2][0].data);
        A = qe.find(c, o[F].location);
        E = fb(cb(A.content));
        {
          if (E[0].id != F) throw "Bad HeaderStorageBucket";
          I = nb(E[0].messages[0].data);
          for (S = 0; S <= n.e.c; ++S) {
            N = nb(I[2][0].data);
            N[1][0].data = tb(S);
            N[4][0].data = tb(n.e.r + 1);
            I[2][S] = { type: I[2][0].type, data: ib(N) };
          }
          E[0].messages[0].data = ib(I);
        }
        A.content = hb(ob(E));
        A.size = A.content.length;
        if (a["!merges"]) {
          var D = u({ type: 6144, deps: [b], location: o[b].location });
          var P = [[], []];
          ...
          x[13] = [{ type: 2, data: bb(D) }];
          v.push({ id: D, messages: [xb(6144, ib(P))] });
        }
        var L = mb(x[4][0].data);
        (function () {
          var e = qe.find(c, o[L].location);
          var r = fb(cb(e.content));
          var t;
          for (var a = 0; a < r.length; ++a) {
            var n = r[a];
            if (n.id == L) t = n;
          }
          var i = nb(t.messages[0].data);
          {
            i[3] = [];
        ...
        {
          var U = M[1][0];
          M[3] = [{ type: 0, data: tb(Ob ? 1 : 0) }];
          var B = nb(U.data);
          {
            var W = mb(B[2][0].data);
            (function () {
              var e = qe.find(c, o[W].location);
              var r = fb(cb(e.content));
              var t;
              for (var a = 0; a < r.length; ++a) {
                var i = r[a];
              ...
              var l = nb(t.messages[0].data);
              {
                delete l[6];
                delete M[7];
                var h = new Uint8Array(l[5][0].data);
                l[5] = [];
                for (var u = 0; u <= n.e.r; ++u) {
                  var d = nb(h);
                  _b(d, s[u], f, Ob);
                  d[1][0].data = tb(u);
                  l[5].push({ data: ib(d), type: 2 });
                }
                l[1] = [{ type: 0, data: tb(0) }];
                l[2] = [{ type: 0, data: tb(0) }];
                l[3] = [{ type: 0, data: tb(0) }];
                l[4] = [{ type: 0, data: tb(n.e.r + 1) }];
                l[6] = [{ type: 0, data: tb(5) }];
                l[7] = [{ type: 0, data: tb(1) }];
                l[8] = [{ type: 0, data: tb(Ob ? 1 : 0) }];
              }
              t.messages[0].data = ib(l);
              e.content = hb(ob(r));
              e.size = e.content.length;
            })();
          }
  ...
  function Pb(e, r) {
    ...
    try {
      e = r.map(function a(r) {
        ...
        return [r.name, e["!id"][r.id].Target, Db(e["!id"][r.id].Type)];
      });
    } catch (t) {
      return null;
    }
  ...
  function Lb(e, r, t, a, n, i, s, f, o, l, c, h) {
    try {
      i[a] = Qn(Nr(e, t, true), r);
      var u = Ir(e, r);
      var d;
      switch (f) {
        case "sheet":
          d = dg(u, r, n, o, i[a], l, c, h);
          break;
        case "chart":
          d = vg(u, r, n, o, i[a], l, c, h);
          if (!d || !d["!drawel"]) break;
          var v = Ur(d["!drawel"].Target, r);
          var p = Zn(v);
          var g = th(Nr(e, v, true), Qn(Nr(e, p, true), v));
          var m = Ur(g, v);
          var b = Zn(m);
          d = Pp(Nr(e, m, true), m, o, Qn(Nr(e, b, true), m), l, d);
          break;
        case "macro":
      ...
      var w = [];
      if (i && i[a])
        ar(i[a]).forEach(function (t) {
          var n = "";
          if (i[a][t].Type == qn.CMNT) {
            n = Ur(i[a][t].Target, r);
            var s = wg(Ir(e, n, true), n, o);
            if (!s || !s.length) return;
            ih(d, s, false);
          }
          if (i[a][t].Type == qn.TCMNT) {
            n = Ur(i[a][t].Target, r);
            w = w.concat(oh(Ir(e, n, true), o));
          }
        });
  ...
  function Ub(e, r) {
    ...
    r = r || {};
    Nb(r);
    if (Or(e, "META-INF/manifest.xml")) return zm(e, r);
    if (Or(e, "objectdata.xml")) return zm(e, r);
    if (Or(e, "Index/Document.iwa")) {
      if (typeof Uint8Array == "undefined")
        throw new Error("NUMBERS file parsing requires Uint8Array support");
      if (typeof Sb != "undefined") {
        if (e.FileIndex) return Sb(e);
    ...
    if (!Or(e, "[Content_Types].xml")) {
      if (Or(e, "index.xml.gz")) throw new Error("Unsupported NUMBERS 08 file");
      if (Or(e, "index.xml")) throw new Error("Unsupported NUMBERS 09 file");
      throw new Error("Unsupported ZIP file");
    }
    var a = Dr(e);
    var n = Kn(Nr(e, "[Content_Types].xml"));
    var i = false;
    var s, f;
    if (n.workbooks.length === 0) {
      f = "xl/workbook.xml";
      if (Ir(e, f, true)) n.workbooks.push(f);
    }
    if (n.workbooks.length === 0) {
      f = "xl/workbook.bin";
      if (!Ir(e, f, true)) throw new Error("Could not find workbook");
      n.workbooks.push(f);
      i = true;
    }
    ...
    if (!r.bookSheets && !r.bookProps) {
      ...
      if (n.sst)
        try {
          xd = bg(Ir(e, Mb(n.sst)), n.sst, r);
        } catch (c) {
          if (r.WTF) throw c;
        }
      if (r.cellStyles && n.themes.length)
        o = Rc(Nr(e, n.themes[0].replace(/^\//, ""), true) || "", r);
      if (n.style) l = mg(Ir(e, Mb(n.style)), n.style, o, r);
    }
    n.links.map(function (t) {
      try {
        var a = Qn(Nr(e, Zn(Mb(t))), t);
        return Tg(Ir(e, Mb(t)), a, t, r);
      } catch (n) {}
    });
    var h = ug(Ir(e, Mb(n.workbooks[0])), n.workbooks[0], r);
    var u = {},
      d = "";
    if (n.coreprops.length) {
      d = Ir(e, Mb(n.coreprops[0]), true);
      if (d) u = hi(d);
      if (n.extprops.length !== 0) {
        d = Ir(e, Mb(n.extprops[0]), true);
        if (d) mi(d, u, r);
      }
    }
    var v = {};
    ...
    if (r.bookDeps && n.calcchain)
      g = kg(Ir(e, Mb(n.calcchain)), n.calcchain, r);
    var m = 0;
    var b = {};
    var w, k;
    {
    ...
    if (!Or(e, y)) y = "xl/_rels/workbook." + E + ".rels";
    var S = Qn(Nr(e, y, true), y.replace(/_rels.*/, "s5s"));
    if ((n.metadata || []).length >= 1) {
      r.xlmeta = Ag(Ir(e, Mb(n.metadata[0])), n.metadata[0], r);
    }
    if ((n.people || []).length >= 1) {
      r.people = ch(Ir(e, Mb(n.people[0])), r);
    }
    if (S) S = Pb(S, h.Sheets);
    var _ = Ir(e, "xl/worksheets/sheet.xml", true) ? 1 : 0;
    e: for (m = 0; m != u.Worksheets; ++m) {
      var x = "sheet";
      if (S && S[m]) {
        w = "xl/" + S[m][1].replace(/[\/]?xl\//, "");
        if (!Or(e, w)) w = S[m][1];
        if (!Or(e, w)) w = y.replace(/_rels\/.*$/, "") + S[m][1];
        x = S[m][2];
      } else {
      ...
      Lb(e, w, k, u.SheetNames[m], m, b, s, x, r, h, o, l);
    }
    p = {
      Directory: n,
      Workbook: h,
    ...
    if (r && r.bookVBA) {
      if (n.vba.length > 0) p.vbaraw = Ir(e, Mb(n.vba[0]), true);
      else if (n.defaults && n.defaults.bin === bh)
        p.vbaraw = Ir(e, "xl/vbaProject.bin", true);
    }
    return p;
  }
  function Bb(e, r) {
  ...
  function Wb(e, r) {
    ...
    if (e.Custprops !== e.Props && ar(e.Custprops || {}).length > 0) {
      s = "docProps/custom.xml";
      Pr(i, s, Ti(e.Custprops, r));
      n.custprops.push(s);
    ...
    for (f = 1; f <= e.SheetNames.length; ++f) {
      ...
      if (h) {
        ...
        if (h["!legacy"]) {
          if (v)
            Pr(i, "xl/drawings/vmlDrawing" + f + ".vml", nh(f, h["!comments"]));
        }
        delete h["!comments"];
        delete h["!legacy"];
      }
      if (c["!id"].rId1) Pr(i, Zn(s), ei(c));
    }
    if (r.Strings != null && r.Strings.length > 0) {
      s = "xl/sharedStrings." + t;
      Pr(i, s, Xo(r.Strings, r));
      n.strs.push(s);
    ...
    Pr(i, "[Content_Types].xml", Jn(n, r));
    Pr(i, "_rels/.rels", ei(r.rels));
    Pr(i, "xl/_rels/workbook." + t + ".rels", ei(r.wbrels));
    delete r.revssf;
    delete r.ssf;
    return i;
  }
  function Hb(e, r) {
    ...
    for (f = 1; f <= e.SheetNames.length; ++f) {
      ...
      if (u) {
        ...
        if (u["!legacy"]) {
          if (p)
            Pr(i, "xl/drawings/vmlDrawing" + f + ".vml", nh(f, u["!comments"]));
        }
        delete u["!comments"];
        delete u["!legacy"];
      }
      if (h["!id"].rId1) Pr(i, Zn(s), ei(h));
    }
    if (r.Strings != null && r.Strings.length > 0) {
      s = "xl/sharedStrings." + t;
      Pr(i, s, Ho(r.Strings, r));
      n.strs.push(s);
      ri(r.wbrels, -1, "sharedStrings." + t, qn.SST);
    }
    s = "xl/workbook." + t;
  ...
  function Vb(e, r) {
    if (qe.find(e, "EncryptedPackage")) return Bb(e, r);
    return nm(e, r);
  }
  function Gb(e, r) {
    var t,
  ...
  function Xb(e, r) {
    ...
    if (a[0] == 239 && a[1] == 187 && a[2] == 191) t = ht(t);
    r.type = "binary";
    return jb(t, r);
  }
  function $b(e, r) {
  ...
  function Jb(e, r) {
    ...
    if (typeof ArrayBuffer !== "undefined" && e instanceof ArrayBuffer)
      return Jb(new Uint8Array(e), ((t = kr(t)), (t.type = "array"), t));
    ...
    switch ((n = zb(a, t))[0]) {
      case 208:
        if (
          ...
          return Vb(qe.read(a, t), t);
        break;
      case 9:
        if (n[1] <= 8) return nm(a, t);
        break;
      case 60:
        return Pg(a, t);
      case 73:
      ...
      case 84:
        ...
        break;
      case 80:
        return n[1] === 75 && n[2] < 9 && n[3] < 9 ? Gb(a, t) : Kb(e, a, t, i);
      case 239:
        return n[3] === 60 ? Pg(a, t) : Kb(e, a, t, i);
      case 255:
        if (n[1] === 254) {
          return $b(a, t);
  ...
  function Zb(e, r) {
    switch (r.type) {
      ...
      case "array":
        ...
        break;
      case "file":
        return rr(r.file, qe.write(e, { type: T ? "buffer" : "" }));
      case "string":
        throw new Error(
  ...
  function tw(e, r) {
    ...
    if (r.password && typeof encrypt_agile !== "undefined")
      return Zb(encrypt_agile(n, r.password), r);
    if (r.type === "file") return rr(r.file, n);
    return r.type == "string" ? ht(n) : n;
  }
  function aw(e, r) {
    var t = r || {};
    var a = im(e, t);
  ...
  function nw(e, r, t) {
    ...
    switch (r.type) {
      ...
      case "string":
        return e;
      case "file":
        return rr(r.file, a, "utf8");
      case "buffer": {
        if (T) return A(a, "utf8");
        else if (typeof TextEncoder !== "undefined")
          return new TextEncoder().encode(a);
        else
          return nw(a, { type: "binary" })
            .split("")
            .map(function (e) {
              return e.charCodeAt(0);
            });
  ...
  function sw(e, r) {
    switch (r.type) {
      ...
      case "binary":
        ...
        return r.type == "base64" ? w(t) : r.type == "string" ? ht(t) : t;
      case "file":
        return rr(r.file, e);
      case "buffer":
        return e;
  ...
  function ow(e, r) {
    ...
    switch (t.bookType || "xlsb") {
      ...
      case "slk":
      case "sylk":
        return nw(Eo.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
      case "htm":
      case "html":
        return nw(Fm(e.Sheets[e.SheetNames[n]], t), t);
      case "txt":
        return iw(bw(e.Sheets[e.SheetNames[n]], t), t);
      case "csv":
        return nw(mw(e.Sheets[e.SheetNames[n]], t), t, "\ufeff");
      case "dif":
        return nw(Co.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
      case "dbf":
        return sw(Ao.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
      case "prn":
        return nw(So.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
      case "rtf":
        return nw(gl.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
      case "eth":
        return nw(yo.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
      case "fods":
        return nw(Xm(e, t), t);
      case "wk1":
        return sw(xo.sheet_to_wk1(e.Sheets[e.SheetNames[n]], t), t);
      case "wk3":
        return sw(xo.book_to_wk3(e, t), t);
      case "biff2":
        if (!t.biff) t.biff = 2;
      case "biff3":
        if (!t.biff) t.biff = 3;
  ...
  function uw(e, r, t, a) {
    ...
    return Ze.writeFile(e, ow(r, n), i);
  }
  function dw(e, r, t, a, n, i, s, f) {
    var o = Ea(t);
    var l = f.defval,
  ...
  function gw(e, r, t, a, n, i, s, f) {
    ...
    for (var u = r.s.c; u <= r.e.c; ++u) {
      ...
      if (d == null) c = "";
        ...
        o = false;
        c = "" + (f.rawNumbers && d.t == "n" ? d.v : Ma(d, null, f));
  ...
  function mw(e, r) {
    ...
    for (var v = n.s.c; v <= n.e.c; ++v) if (!(u[v] || {}).hidden) h[v] = _a(v);
    var p = 0;
    for (var g = n.s.r; g <= n.e.r; ++g) {
      if ((d[g] || {}).hidden) continue;
      c = gw(e, n, g, h, s, o, i, a);
      if (c == null) {
        continue;
      }
  ...
  function kw(e, r, t) {
    ...
    var v = Ea(s);
    if (n)
      for (d = 0; d < u.length; ++d) i[_a(d + f) + v] = { t: "s", v: u[d] };
    i["!ref"] = Da(c);
    return i;
  }
  function Tw(e, r) {
  ...
  function Aw(e, r, t) {
    ...
    if (typeof r != "number") return Aw(e, Na(r));
    return Aw(e, Na({ r: r, c: t || 0 }));
  }
  function Ew(e, r) {
    if (typeof r == "number") {
  ...
  function Iw(e, r, t, a) {
    var n = typeof r != "string" ? r : Pa(r);
    var i = typeof r == "string" ? r : Da(r);
  ...
  var Nw = {
    ...
    sheet_to_json: vw,
    sheet_to_html: Fm,
    sheet_to_formulae: ww,
    sheet_to_row_object_array: vw,
    sheet_get_cell: Aw,
    book_new: Cw,
    book_append_sheet: yw,
    book_set_sheet_visibility: Sw,
    cell_set_number_format: _w,
    cell_set_hyperlink: xw,
    cell_set_internal_link: Ow,
    cell_add_comment: Rw,
    sheet_set_array_formula: Iw,
  ...
  function Lw(e, r) {
    var t = Fw();
    var a = r || {};
    var n = a.header != null ? a.header : Om;
    var i = a.footer != null ? a.footer : Rm;
    t.push(n);
    var s = Fa(e["!ref"]);
    a.dense = Array.isArray(e);
    t.push(Nm(e, s, a));
  ...
  var Uw = { to_json: Mw, to_html: Lw, to_csv: Pw, set_readable: Dw };
  if (typeof nm !== "undefined") e.parse_xlscfb = nm;
  e.parse_zip = Ub;
  e.read = Jb;
  e.readFile = qb;
  e.readFileSync = qb;
  ...
  e.writeFileXLSX = hw;
  e.SSF = Ve;
  if (typeof Uw !== "undefined") e.stream = Uw;
  if (typeof qe !== "undefined") e.CFB = qe;
  if (typeof require !== "undefined") {
    var Bw = undefined;
    if ((Bw || {}).Readable) Dw(Bw.Readable);
  }
}
