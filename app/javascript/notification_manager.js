...
async function subscribeToNotifications() {
  try {
    ...
    const vapidPublicKeyElement = document.querySelector('meta[name="push-notification-key"]');
...
async function unsubscribeFromNotifications() {
  try {
    ...
    const subscriptionId = localStorage.getItem('pushNotificationSubscriptionId');
    if (subscriptionId) {
...
export { requestNotificationPermission, subscribeToNotifications, unsubscribeFromNotifications };
