...
class CarnegieMellonIdCard
  ...
  def self.get_andrewid_by_card_id(full_card_id)
    begin
      ...
      response_json = {
        first_name:
          response.body[:get_card_holder_by_card_id_response][
            :get_card_holder_by_card_id_result
          ][
            :first_name
          ],
        last_name:
  ...
  def self.get_andrewid_by_card_csn(full_card_csn)
    begin
      ...
      response_json = {
        first_name:
          response.body[:get_card_holder_by_smar_card_csn_response][
            :get_card_holder_by_smar_card_csn_result
          ][
            :first_name
          ],
        last_name:
