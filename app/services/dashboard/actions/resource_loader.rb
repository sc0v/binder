  ...
  module Actions
    module ResourceLoader
      RESOURCE_DEFS = {
        ...
        organization: { model: Organization, param: 'organization_id',
                        error_key: 'resources.organization.not_found' },
        organization_required: { model: Organization, param: 'organization_id',
                                 error_key: 'resources.organization.missing' },
        scissor_lift_required: { model: ScissorLift, param: 'scissor_lift_id',
                                 error_key: 'resources.scissor_lift.missing' }
      }.freeze
