    ...
    module ResourceLoader
      RESOURCE_DEFS = {
        tool: {
          model: Tool,
          param: 'tool_id',
          error_key: 'resources.tool.not_found'
        },
        scissor_lift: {
          model: ScissorLift,
          param: 'scissor_lift_id',
          error_key: 'resources.scissor_lift.not_found'
        },
        participant: {
          model: Participant,
          param: 'participant_id',
          error_key: 'resources.participant.missing'
        },
        organization: {
          model: Organization,
