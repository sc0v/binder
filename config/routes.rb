...
Rails.application.routes.draw do
  ...
  get 'power-dashboard/select-organization', to: 'power_dashboard#select_organization',
                                             as: :power_dashboard_select_organization
  post 'power-dashboard/select-organization', to: 'power_dashboard#apply_organization',
