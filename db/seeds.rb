...
when 'development'
  ...
  Shift.create({ shift_type: ShiftType.find_by_name('Watch Shift'), organization: dtd_org, starts_at: Time.now + 10.hours, ends_at: Time.now + 15.hours, required_number_of_participants: 1 })
